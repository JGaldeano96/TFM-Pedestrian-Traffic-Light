...
INPUT_DIR = Path("/home/jgaldeano/tfm/data/source_data/raw_data")
OUTPUT_DIR = Path("/home/jgaldeano/tfm/data/source_data/processed_data")
...
def convert_mov_to_mp4(input_video: Path, output_video: Path):
    """
    ...
    for line in process.stdout:
        ...
        if line.startswith("out_time_ms="):
            ...
            if percent != last_percent:
                ...
                print(f"\r   Conversión: {percent:3d} %", end="")
...
for index, input_video in enumerate(videos, start=1):
    ...
    try:
        ...
        if input_video.suffix.lower() == ".mp4":
            ...
            convert_mov_to_mp4(input_video, output_video)
